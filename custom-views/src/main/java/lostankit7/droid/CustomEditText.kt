...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        ...
        cPaddingLeft =
            a.getDimensionPixelSize(R.styleable.CustomEditText_android_paddingLeft, DEFAULT_PADDING)
        cPaddingTop =
            a.getDimensionPixelSize(R.styleable.CustomEditText_android_paddingTop, DEFAULT_PADDING)
        ...
        isClearIconVisible =
            a.getBoolean(R.styleable.CustomEditText_setClearIconVisible, false)
        val isBorderView = a.getBoolean(R.styleable.CustomEditText_setBorderView, false)
        val mNormalColor =
            a.getColor(R.styleable.CustomEditText_setBorderColor, DEFAULTCOLOR)
        val cursorColor = a.getColor(R.styleable.CustomEditText_setCursorColor, 0)
        mBackgroundColor =
            a.getColor(R.styleable.CustomEditText_setBackgroundColor, Color.TRANSPARENT)
        mStrokeWidth =
            a.getDimension(R.styleable.CustomEditText_setStrokeWidth, mStrokeWidth)
        hideShowIconTint =
            a.getColor(R.styleable.CustomEditText_hideShowPasswordIconTint, DEFAULTCOLOR)
        clearIconTint = a.getColor(R.styleable.CustomEditText_clearIconTint, DEFAULTCOLOR)
        this.font = a.getString(R.styleable.CustomEditText_setFont)
        mPrefix = a.getString(R.styleable.CustomEditText_setPrefix)
        prefixTextColor = a.getColor(R.styleable.CustomEditText_setPrefixTextColor, 0)
        mCornerRadius = a.getDimension(R.styleable.CustomEditText_setCornerRadius, 1f)
    ...
    private val myPaint = Paint(Paint.ANTI_ALIAS_FLAG or Paint.DITHER_FLAG)
